...
struct Fraction: Equatable, Codable, Sendable {
    ...
    /// Parses "3/4", "-3/4" or "5". The scientific keypad types "÷" rather
    /// than a slash, so both are accepted. Whitespace is ignored. Returns nil
    /// for anything else, including a zero denominator.
